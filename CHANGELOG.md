...
- **Runtime settings validation** -- Numeric settings are clamped to valid ranges on load and save. Invalid values (e.g., negative scan depth) are corrected automatically.
...
- **URL Setting** -- Allow specification of URL instead of a port
